...
function initData(vueOptions, context) {
  ...
  if (typeof data === 'function') {
    try {
      ...
      if (Object({"VUE_APP_NAME":"live","VUE_APP_PLATFORM":"mp-weixin","NODE_ENV":"development","BASE_URL":"/"}).VUE_APP_DEBUG) {
...
var store = new _vuex.default.Store({
  ...
  mutations: {
    change_musicplay: function change_musicplay(state, payload) {
      state.musicplay = payload;
    },
    change_songs: function change_songs(state, payload) {
    ...
    change_songslist: function change_songslist(state, payload) {
      state.songslist.songs = payload;
    },
    change_talk: function change_talk(state, payload) {
      state.talk.comment = payload.comment;
      state.talk.id = payload.id;
      state.talk.page = payload.page;
    },
    save_songs: function save_songs(state, payload) {
      state.index_songs.songs = payload.songs;
    },
    save_recommendation: function save_recommendation(state, payload) {
      console.log(payload.songs, 99);
      state.Song_recommendation.dailySongs = payload.songs;
    },
    save_radio: function save_radio(state, payload) {
      state.Radio_recommendation.result = payload;
    },
    save_video: function save_video(state, payload) {
      state.Video_recommendation.video = payload;
    },
    save_radio_hot: function save_radio_hot(state, payload) {
      console.log('存储了', payload);
      state.Radio_hot.radio = payload;
    },
    save_words: function save_words(state, payload) {
      state.Words = payload;
    } },
...
/***/ 8:
/*!************************************************************************!*\
  !*** F:/live/uni_modules/uni-upgrade-center-app/utils/check-update.js ***!
  \************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.default = _default;var _callCheckVersion = _interopRequireDefault(__webpack_require__(/*! ./call-check-version */ 9));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}
...
/***/ 9:
/*!******************************************************************************!*\
  !*** F:/live/uni_modules/uni-upgrade-center-app/utils/call-check-version.js ***!
  \******************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
